...
public class CajeroUI extends JFrame {
	...
	public CajeroUI() {
		...
		facturarLabel.setBounds(590, 82, 623, 38);
		getContentPane().add(facturarLabel);

		JPanel barrita = new JPanel();
		barrita.setBackground(new Color(24, 124, 129));
		barrita.setBounds(590, 131, 393, 10);
		getContentPane().add(barrita);

		JPanel panel = new JPanel();
		panel.setBounds(229, 156, 1153, 621);
		...
		btnNewButton.setBounds(497, 571, 264, 36);
		...
		btnCerrar.setFont(new Font("Montserrat ExtraBold", Font.PLAIN, 12));
		btnCerrar.setForeground(new Color(255, 255, 255));
		btnCerrar.setBounds(732, 18, 153, 31);
		getContentPane().add(btnCerrar);

		JLabel lblNewLabel = new JLabel("VISTA DE CAJERO");
		lblNewLabel.setForeground(new Color(255, 255, 255));
		lblNewLabel.setBackground(new Color(255, 255, 255));
		lblNewLabel.setBounds(608, 32, 114, 13);
